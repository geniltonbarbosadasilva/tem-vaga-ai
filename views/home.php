...
<body>
    <header>
        <div class="navbar">
            ...
            <div class="menu">
                <ul>
                    <li><a href="#" onclick="document.getElementById('id-modal').style.display='block'"
                            class="transition">Entre</a></li>
                    ...
                    <div id="login" class="login">
                        <form autocomplete="off">
                            ...
                            <button onclick="document.getElementById('id-modal').style.display='none'"
                                class="search-btn transition" type="button">Entrar</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div id="slider" class="slider-container">
        <img id="slide-1" class="mySlides" src="../img/img-1.jpg">
        <img id="slide-2" class="mySlides" src="../img/img-2.jpg">
        <img id="slide-3" class="mySlides" src="../img/img-3.jpg">
